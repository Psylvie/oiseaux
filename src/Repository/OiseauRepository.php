...
/**
 * @extends ServiceEntityRepository<Oiseau>
 *
...
class OiseauRepository extends ServiceEntityRepository
{
    ...
    public function add(Oiseau $entity, bool $flush = false): void
    {
    ...
    public function remove(Oiseau $entity, bool $flush = false): void
    {
